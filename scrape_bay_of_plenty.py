#!/usr/bin/env python3
"""
Scrape dental clinics in the Bay of Plenty region using the Google Places API (New).
Outputs results to dental_clinics_bay_of_plenty.csv

Requires:
    GOOGLE_PLACES_API_KEY environment variable to be set.

Usage:
    python3 scrape_bay_of_plenty.py
"""
...
OUTPUT_FILE = "dental_clinics_bay_of_plenty.csv"
REGION = "Bay of Plenty"

TOWNS = [
    # Tauranga City (searched by suburb to maximise coverage)
    "Tauranga",
    "Mount Maunganui",
    "Papamoa",
    "Papamoa Beach",
