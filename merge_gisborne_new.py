#!/usr/bin/env python3
"""
Filter dental_clinics_gisborne.csv (raw Places API results) down to
...
EXCLUDE_NAME = re.compile(
    ...
    r"the doctors|church\b|community health centre)\b",
    re.IGNORECASE,
)
EXCLUDE_EXACT: set[str] = {
    "dentist",  # no business name, junk listing
    "te aitanga a hauiti",  # iwi/tribal organisation, not a dental business
}
...
with open("dental_clinics_gisborne.csv", encoding="utf-8", newline="") as f:
