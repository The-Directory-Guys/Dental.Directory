#!/usr/bin/env python3
"""
Scrape dental clinics in the West Coast region using the Google Places API (New).
Outputs results to dental_clinics_west_coast_fresh.csv

Covers: Greymouth, Hokitika, Westport, and other West Coast towns.

Requires:
    GOOGLE_PLACES_API_KEY environment variable to be set.

Usage:
    python3 scrape_west_coast.py
"""
...
OUTPUT_FILE = "dental_clinics_west_coast_fresh.csv"
REGION = "West Coast"
...
REGION_MARKERS = TOWNS + ["West Coast"]
