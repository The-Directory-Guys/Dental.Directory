#!/usr/bin/env python3
"""
Scrape dental clinics in the Manawatū-Whanganui region using the Google Places API (New).
Outputs results to dental_clinics_manawatu_whanganui.csv

Requires:
    GOOGLE_PLACES_API_KEY environment variable to be set.

Usage:
    python3 scrape_manawatu_whanganui.py
"""
...
OUTPUT_FILE = "dental_clinics_manawatu_whanganui.csv"
REGION = "Manawatū-Whanganui"

TOWNS = [
    # Palmerston North (searched by suburb to maximise coverage)
...
def main():
    ...
    for town in TOWNS:
        ...
        for place in places:
            ...
            if not any(t in address for t in TOWNS) and REGION not in address:
                continue
