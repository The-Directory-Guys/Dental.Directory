#!/usr/bin/env python3
"""
Scrape dental clinics in the Nelson & Tasman region using the Google Places API (New).
Outputs results to dental_clinics_nelson_tasman_fresh.csv

Covers: Nelson city (searched by suburb to maximise coverage), Tasman
district, and Marlborough-adjacent Golden Bay towns.

Requires:
    GOOGLE_PLACES_API_KEY environment variable to be set.

Usage:
    python3 scrape_nelson_tasman.py
"""
...
OUTPUT_FILE = "dental_clinics_nelson_tasman_fresh.csv"
REGION = "Nelson & Tasman"

TOWNS = [
    # Nelson city (searched by suburb to maximise coverage)
    "Nelson Central",
    "Nelson South",
    "Stoke Nelson",
    "The Wood Nelson",
