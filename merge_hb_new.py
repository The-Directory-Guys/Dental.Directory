#!/usr/bin/env python3
"""
Filter dental_clinics_hawkes_bay.csv (raw Places API results) down to
...
EXCLUDE_NAME = re.compile(
    ...
    r"fallen soldiers|memorial hospital)\b",
    re.IGNORECASE,
)
EXCLUDE_EXACT: set[str] = {
    "dentist",  # no business name, junk listing
    "blackcabslimited",  # not a dental business (taxi company)
    "totara health",  # general health provider, not dental
}
...
with open("dental_clinics_hawkes_bay.csv", encoding="utf-8", newline="") as f:
