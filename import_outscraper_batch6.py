...
CSV_PATH = os.path.join(os.path.dirname(__file__), 'outscraper_batch6.csv')
PROGRESS_PATH = os.path.join(os.path.dirname(__file__), 'outscraper_progress_batch6.json')
RAW_PATH = os.path.join(os.path.dirname(__file__), 'outscraper_raw_responses_batch6.jsonl')
