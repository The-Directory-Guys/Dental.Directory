...
(function (window) {
  const URL$  = (window.DC_SUPABASE_URL || 'https://ydcminsdkiccbngkbvpg.supabase.co') + '/auth/v1';
  const KEY   = window.DC_SUPABASE_ANON_KEY || 'sb_publishable_ikGnFs7m_Q8oIJLOddKuSg_6A8Mkoed';
