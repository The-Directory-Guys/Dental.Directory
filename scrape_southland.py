#!/usr/bin/env python3
"""
Scrape dental clinics in the Southland region using the Google Places API (New).
Outputs results to dental_clinics_southland_fresh.csv

Covers: Invercargill (searched by suburb to maximise coverage), Gore,
Winton, and other Southland towns.

Requires:
    GOOGLE_PLACES_API_KEY environment variable to be set.

Usage:
    python3 scrape_southland.py
"""
...
OUTPUT_FILE = "dental_clinics_southland_fresh.csv"
REGION = "Southland"

TOWNS = [
    # Invercargill city (searched by suburb to maximise coverage)
...
REGION_MARKERS = TOWNS + ["Invercargill", "Southland"]
