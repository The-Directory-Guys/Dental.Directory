#!/usr/bin/env bash
# Scrape all NZ dental clinic data and merge into a single CSV.
# To import the result into Supabase, run import.sh afterwards.
#
# Required env vars:
...
echo "Run ./import.sh to load the data into Supabase."
