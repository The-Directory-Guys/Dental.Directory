...
CSV_PATH = os.path.join(os.path.dirname(__file__), 'outscraper_batch5.csv')
PROGRESS_PATH = os.path.join(os.path.dirname(__file__), 'outscraper_progress_batch5.json')
RAW_PATH = os.path.join(os.path.dirname(__file__), 'outscraper_raw_responses_batch5.jsonl')
